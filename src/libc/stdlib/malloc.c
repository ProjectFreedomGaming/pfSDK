...
// -- A warning is triggered by what looks like a pointer being set to after
// -- a header struct.
// -- Rather than risk breaking something by quieting the warning, we disable the warning for this file.
